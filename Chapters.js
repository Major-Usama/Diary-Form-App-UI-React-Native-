                ...
                justifyContent:'center',alignItems:'center',marginVertical:hp('-4%'),right:wp('7.5%')}}>
                    ...
                    <View style={{left:wp('3.5%')}}>
                      <Text style={{fontFamily:'Poppins-Light',marginVertical:hp('.5%'),fontSize:10,color:'#fff'}}>
                          <Text style={{fontFamily:'Poppins-Light',marginVertical:hp('1%'),fontSize:10,color:'#ECBD45'}}>01 </Text> Business Ethics 101</Text>

                      <Text style={{fontFamily:'Poppins-Light',marginVertical:hp('.5%'),fontSize:10,color:'#fff'}}>
                          <Text style={{fontFamily:'Poppins-Light',fontSize:10,color:'#ECBD45'}}>02 </Text>
                      Situational Peril</Text>
                      <Text style={{fontFamily:'Poppins-Light',fontSize:10,color:'#fff',marginVertical:hp('.5%')}}>
                          <Text style={{fontFamily:'Poppins-Light',fontSize:10,color:'#ECBD45'}}>03 </Text>Compund Strat</Text>
                      <Text style={{fontFamily:'Poppins-Light',fontSize:10,color:'#fff'}}>
                          <Text style={{fontFamily:'Poppins-Light',fontSize:10,color:'#ECBD45',marginVertical:hp('.5%')}}>04 </Text> Low-End Ins & out</Text>
                      <Text style={{fontFamily:'Poppins-Light',fontSize:10,color:'#fff',marginVertical:hp('.5%')}}>
                          <Text style={{fontFamily:'Poppins-Light',fontSize:10,color:'#ECBD45',marginVertical:hp('.5%')}}>05 </Text> Ratio</Text>
