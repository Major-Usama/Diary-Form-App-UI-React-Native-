...
import { Image, ImageBackground, StyleSheet, Text, View, TextInput,Platform,StatusBar,TouchableOpacity } from 'react-native'
    ...
    return (
        <ImageBackground style={styles.container} source={require('./assets/bottomhome.jpg')}>
            ...
            <View style={{
                ...
                , marginVertical: hp('0%'), alignItems: 'center', marginHorizontal: wp('-18%')
            }}>
                ...
                <FontAwesome5 name="user" size={22} color="#B0A5E3" style={{ left: wp('0%') }} />
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-around', marginVertical: hp('-2%') }}>
                ...
                <Text style={{
                    ...
                    left: wp('3%'), marginVertical: '.3%', alignItems: 'center', justifyContent: 'center'
                ...
                <View style={{
                    ...
                    <Text onPress={()=>navigation.navigate('CreateDiary')} style={{ fontSize: wp('2.9%'), fontFamily: 'Poppins-SemiBold', fontSize: wp('3.0%') }}>Create Diary</Text>
            ...
            <View style={{ flexDirection: 'row', marginVertical: wp('0%'), right: wp('1.5%') }}>

                <View style={{
                    marginHorizontal: wp('8%'), backgroundColor: '#343434', borderRadius: 12, height: hp('38%'),
                ...
                <View style={{
                    borderRadius: 12, height: hp('37%'),
                    width: wp('9%'), justifyContent: 'center', alignItems: 'center', marginHorizontal: wp('14.5%')
                }}>


                    <Text style={{ fontFamily: 'Poppins-SemiBold', fontSize: 18, width: wp('24%'), color: '#8772CF' ,bottom:hp('1')}}>Chapters</Text>
                ...
                <View style={{ marginHorizontal: wp('-8%'), marginVertical: '18%' }}>
            ...
            <View style={{ top: hp('1%'), marginHorizontal: wp('4%') }}>
            ...
            <View style={{ bottom: wp('14%') }}>
                ...
                <ImageBackground source={require('./assets/browse.png')} style={{
                    width: wp('90%'),
                    marginLeft: 20,
                    height: hp('26%')
                }} >
                    ...
                    <View style={{ flexDirection: 'row', left: wp('1%'), justifyContent: 'space-around', }}>
                        <View style={{ height: wp('48%'), justifyContent: 'center', marginHorizontal: wp('2.5%') }}>
                            ...
                            <View style={{ alignItems: 'center', flexDirection: 'row' }}>
                                <Text onPress={()=>navigation.navigate('CreateDiary')} style={{ fontFamily: "Poppins-Bold", color: '#8772CF', fontSize: wp('2.5%'), marginLeft: wp('.8%') }}>View</Text>
                        ...
                        <View style={{
                            ...
                            <Text numberOfLines={1} style={{ fontFamily: 'Poppins-SemiBold', fontSize: wp('4.6%'), color: '#ECBD45', right: wp('3.2%') }}>Chapters</Text>
                      ...
                      Overcast Days</Text>
                        ...
                        <View style={{ alignItems: 'center', justifyContent: "space-around", }}>
                            <Entypo name="plus" size={24} color="#EDBE46" onPress={()=>navigation.navigate('Chapters')} />
