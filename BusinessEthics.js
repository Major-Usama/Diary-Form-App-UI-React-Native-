    ...
    return (
        ...
        paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight : 0,
            ...
            <View style={{
                ...
                <Text style={{ fontSize: wp('11%'), fontFamily: 'Poppins-ExtraBold', color: '#FFCB47', top: hp('1%') }}>
                    01
                </Text>
            ...
            <View>
                <Text style={{ fontFamily: 'Poppins-Bold', fontSize: wp('6%'), marginHorizontal: wp('9.5%'), top: hp('-2.2%') }}>Business Ethics</Text>
            ...
            <Text style={{ fontSize: wp('3.2%'), top: hp('10%'), fontFamily: 'Poppins-Bold', color: 'red', marginHorizontal: wp('10.5%') }}>TEXT EDITOR PANEL INTEGRATION</Text>
            </View>
